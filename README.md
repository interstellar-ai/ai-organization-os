...
- The manual external-result fallback accepts only a public HTTPS destination and explicit Founder attestations. Its evidence is marked as human-reported and not independently verified.
