...
- An unavailable route can be closed with a reason, optional two-letter country or region code, account type, and payment method. The rejected route remains auditable while the next compatible catalog route becomes the active Founder action.
